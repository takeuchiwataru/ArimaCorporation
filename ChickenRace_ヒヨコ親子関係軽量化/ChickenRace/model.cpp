...
D3DXVECTOR3			CModel::m_VtxMax = D3DXVECTOR3(-10000, -10000, -10000);			//最大値
D3DXVECTOR3			CModel::m_VtxMin = D3DXVECTOR3(10000, 10000, 10000);			//最小値
	...
	if (Shader != NULL)
	{
		...
		//{
			...
			for (int nCntMat = 0; nCntMat < (int)m_nNumMat; nCntMat++)
			{
				...
				else if (m_pShaderMeshTextures == NULL)
				{
					//テクスチャがない場合
					m_bTexMat = false;
					//シェーダーにboolの情報を渡す
