...
private:
	static LPD3DXMESH	m_pMesh[MAX_CHICK_PARTS];			//メッシュ情報へのポインタ
	static LPD3DXBUFFER	m_pBuffMat[MAX_CHICK_PARTS];		//マテリアルの情報へのポインタ
	static DWORD		m_nNumMat[MAX_CHICK_PARTS];			//マテリアルの情報数
	...
	// モーション関数	新規								 
	CModel				*m_apModel[MAX_CHICK_PARTS];	// パーツモデルのポインタ
