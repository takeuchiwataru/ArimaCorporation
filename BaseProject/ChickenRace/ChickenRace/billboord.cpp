...
//　クリエイト
//===============================================================================
CBillBoord * CBillBoord::Create(D3DXVECTOR3 pos, D3DXVECTOR2 size,int nTexType, bool bMap)
{
...
HRESULT CBillBoord::Load(void)
{
	...
	// テクスチャの生成
	m_pTexture[0] = NULL;
	D3DXCreateTextureFromFile(pDevice, BILL_TEXTURE_NAME_1, &m_pTexture[1]);
