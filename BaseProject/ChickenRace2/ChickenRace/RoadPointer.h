...
public:
	...
	float			GetfRotY(void);
	float			GetGDistance(D3DXVECTOR3 &pos, int nMap);
	...
	static	float			NextRot(D3DXVECTOR3 &pos, CRoad_Pointer *&pmyPoint, float &fRoad, int &nMap, int nNumber, CCOL_MESH::EFFECT &effect, float &fCntTime);
